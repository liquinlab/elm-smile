    ...
    <div class="page prevent-select">
        ...
        <div class="payment" v-if="api.getRecruitmentService() == 'prolific'">
            ...
            <p class="has-text-left pb-5">
                Please click the button below to begin the process of payment.
                This will notify Prolific you
                successfully completed the task. Your work will be approved
                within several hours and any performance
                related bonuses will be assigned at that time. We really
                appreciate your time.
            </p>
            <hr>
            <a :href="`https://app.prolific.co/submissions/complete?cc=${completionCode}`"
                class="button is-info">Submit my work to Prolific &nbsp;
                <FAIcon icon="fa-solid fa-arrow-right" />
            </a>
        </div>
        <div class="payment"
            v-if="api.getRecruitmentService() == 'cloudresearch'">
            <h1 class="title is-3">Thanks, let's begin the payment process!</h1>
            <p class="has-text-left pb-5">
                Please copy the code displayed below (or click the button) and
                paste it into the Mechanical Turk window
                to begin the process of payment.
                Your work will be approved within several hours and any
                performance
                related bonuses will be assigned at that time. We really
                appreciate your time.
            </p>
            ...
            <span class="completioncode">{{ completionCode }}</span><button
                class="button is-info" id="copy_code"
                data-clipboard-target=".completioncode">Copy Code &nbsp;
        ...
        <div class="payment" v-if="api.getRecruitmentService() == 'mturk'">
            <h1 class="title is-3">Thanks, let's begin the payment process!</h1>
            <p class="has-text-left pb-5">
                Please verify the code displayed below is visible in the form on
                the Mechanical Turk website.
                If it is not click the button to copy it to your clipboard and
                paste it into the Mechanical Turk window
                to begin the process of payment.
                Your work will be approved within several hours and any
                performance
        ...
        <div class="payment" v-if="api.getRecruitmentService() == 'web'">
            ...
            Your data have been successfully recorded and you can close this
            window or navigate to another page.
            </p>
        </div>
    </div>
</template>
