...
<template>
  <div class="absolute inset-0 z-50 flex items-center justify-center p-8" :class="{ hidden: !show }">
    ...
    <div class="w-[90%] h-[90%] relative bg-background border border-border flex flex-col">
        ...
        <div class="p-6">
          ...
          <div class="mt-10">
            <div class="flex gap-6">
              <div class="w-2/5">
                <div class="text-left text-muted-foreground">
                  <p class="text-sm text-muted-foreground">
                    You are free to withdraw from this study at any time. Withdrawing from the study <b>may</b> affect
                    the total amount of your compensation. We will follow up with you about partial compensation.
                    <b
              ...
              <div class="flex-1">
                <div class="border border-border text-left bg-muted text-foreground p-6 rounded-lg">
                  <div class="space-y-6">
                    <div class="space-y-4">
                    ...
                    <div class="space-y-3">
                      ...
                      />
                      <p class="text-xs text-gray-500">
                        Please enter your email address so we can follow up with you. This is optional and we otherwise
                        will try to figure out how to reach you. However, this can help avoid any potential problems.
                        Feel free to use an anonymized email like your Prolific contact email, Hide my email (Apple), or
                        create a free alias on SimpleLogin. We will not associate this email with your data nor use it
                        for any purpose other than contacting you to resolve the issue.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div class="border-t bg-muted px-5 py-4 flex justify-end space-x-4">
