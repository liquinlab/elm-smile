    ...
    <template #right>
      <div v-if="api.pathString === 'survey_page1'" class="border border-border text-left bg-muted p-6 rounded-lg">
        ...
        <div class="mb-3">
          ...
          <p class="text-xs text-muted-foreground mt-1">Are you able to speak and understanding English? (required)</p>
        </div>
      ...
      <div v-else-if="api.pathString === 'survey_page2'" class="border border-border text-left bg-muted p-6 rounded-lg">
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <p class="text-xs text-muted-foreground mt-1">Do you have diagnosis of a psychiatric disorder? (required)</p>
        </div>
      ...
      <div v-else-if="api.pathString === 'survey_page3'" class="border border-border text-left bg-muted p-6 rounded-lg">
        <div class="mb-3">
