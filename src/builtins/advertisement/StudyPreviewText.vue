        ...
        <div class="columns">
            <div class="column">
                ...
                <p class="is-size-5 has-text-left">
                    ...
                    that we will pay you at the end of the study ({{
                        api.config.payrate }}). The study
                    should take about {{ api.config.estimated_time }} of your
                    time. You'll be
                    asked to digitally sign a constent form and (optionally)
                    provide some
                    non-identifiable demographic information during the study.
                    Your data will be kept anonymous.
                    <hr>
                    <b>Summary:</b> This study is like a game, is mentally
                    challenging,
                    requires concentration, can only be played once, and
            ...
            <div class="column is-two-fifths">
                ...
                <article class="message">
                    ...
                    <div class="message-body is-size-7 has-text-left">
                        ...
                        the
                        direction to <a href="http://todd.gureckislab.org"
                            target="_blank">Dr. Todd Gureckis</a>. Our
                        lab uses games and other fun tasks to study human
                        intellience. Our research is funded in the public
                        interest by the United States <a href="https://nsf.gov"
                            target="_new">National Science Foundation</a> among
                        other organizations and
                        non-profit foundations and we publish our work, code,
                        and results for the public. We very much appreciate
                        research participants in our studies and have a public
                        <a href="http://gureckislab.org/research-code-of-ethics.html"
                            target="_new">code
